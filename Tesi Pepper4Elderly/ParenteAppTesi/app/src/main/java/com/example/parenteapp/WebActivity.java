...
//		mWebView.loadDataWithBaseURL("", url, "text/html", "utf-8", "");
        ...
        if(getIntent().getExtras().getInt("type") != 0)
            url = "https://bettercallpepper.altervista.org/VideoChatEstensione/?room="+myAppID + "_" + getIntent().getExtras().getInt("id") +"&mode=c&pepper=0";
        else
            url = "https://bettercallpepper.altervista.org/VideoChatEstensione/?room="+myAppID + "_" + receiveCallID +"&mode=j&pepper=0";

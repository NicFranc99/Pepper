...
public class WebActivity extends AppCompatActivity {
    ...
    private Intent intentMattutino;
    ...
    private void chiusuraToast(){
        CharSequence text = "L'operatore ha chiuso";
    ...
    private void init(){
        String precactivity = NowIsRunning;
        Globals.NowIsRunning = Globals.WebActivity;
        System.out.println("settato now is running web" + Globals.NowIsRunning );
        free = false;
        intentMattutino = new Intent(this, CheckMattutino.class);
...
//		mWebView.loadDataWithBaseURL("", url, "text/html", "utf-8", "");
        ...
        if(getIntent().getExtras().getInt("type") != 0)
            url = "https://bettercallpepper.altervista.org/VideoChatEstensione/?room="+myAppID + "_" + getIntent().getExtras().getInt("id") +"&mode=c"+"&pepper=1";
        else
            url = "https://bettercallpepper.altervista.org/VideoChatEstensione/?room="+receiveCallID + "_" + myAppID +"&mode=j"+"&pepper=1";
        ...
        builder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(tornaNav){
                    ...
                    NowIsRunning = Globals.ProfileActivity;

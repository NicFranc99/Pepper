...
public class AvvisoFragmentProfile extends Fragment {

    private static final String TAG = "MSI_ProfileFragment";
    private ProfileActivity ma;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        this.ma = (ProfileActivity) getActivity();
        //ma.status.reset();
        ...
        accetta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(ritorna){
                    ritorna = false;
                    WebActivity.tornaNav = true;}
                ma.startActivity(intent);
                System.out.println("ACCETTA" );
                MainActivity.chiamataGestita = false;
                Globals.chiamataInArrivo = false;
